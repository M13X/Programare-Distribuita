    ...
    try {
      ...
      while(ch.startsWith("Y")){
        ...
        if(ch.startsWith("Y")){
		  ...
		  System.out.println("Afisare:1, Inserare:2");
          do{
            prel=0;
            try{
          ...
          switch(prel){
            case 1 :
              System.out.println("ID Tablou");              
              //nume='\''+scanner.next().trim()+'\'';
			  int i = scanner.nextInt();
              sql="select * from tablou where id="+i;
			...
			case 2:
				...
				String rz = sb.toString();
				System.out.println(rz);
				sql="insert into tablou(valori) values('"+rz+"')";
				instructiune.executeUpdate(sql);
				//rs=instructiune.executeQuery(sql); 
				break;
			/*
            case 2 :
          ...
          if(rs!=null){
            ...
            while(rs.next()){
              ...
              System.out.println("valori=" + rs.getString("valori"));
              System.out.println("-----------------");
            }
          }
          else{
